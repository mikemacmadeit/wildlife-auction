...
export const metadata: Metadata = {
  title: 'Marketplace Policies | Agchange',
  description:
    'Marketplace policies, category disclaimers, and risk acknowledgments for Agchange.',
};
    ...
    <div className="container mx-auto px-4 py-10 max-w-4xl">
      ...
      <Alert className="mb-8">
        ...
        <AlertDescription className="text-sm">
          Agchange is a technology marketplace only. These policies set marketplace rules and category-level disclaimers.
          They do not make Agchange a seller, dealer, broker, agent, or auctioneer.
        </AlertDescription>
      </Alert>
      ...
      <div className="space-y-8">
          ...
          <CardContent className="space-y-5 text-sm text-foreground">
            <div className="space-y-2">
              ...
              <ul className="list-disc ml-5 space-y-1">
                <li>Agchange does not take custody, possession, or control of any animal at any time.</li>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc ml-5 space-y-1">
                <li>Listings are provided “AS-IS, WHERE-IS.” Agchange makes no warranty of condition, title, or fitness.</li>
                <li>Buyer and seller are responsible for inspection, title/VIN verification, liens, taxes, and transfer paperwork.</li>
                <li>Agchange does not provide transport; any shipping/hauling is arranged between buyer, seller, and third parties.</li>
              </ul>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-foreground">
            ...
            <p>
              Agchange may require certain documents to be uploaded for platform workflow purposes. Any “verified” label means the document
