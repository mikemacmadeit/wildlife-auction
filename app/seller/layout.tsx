  ...
  return (
    <RequireAuth>
      ...
      <aside
        ...
        style={{ pointerEvents: 'auto', zIndex: 9999, isolation: 'isolate' }}
      >
            {/* Logo Section */}
        ...
        {/* Navigation */}
        <nav className={cn('flex-1 overflow-y-auto py-4 space-y-1 min-h-0 we-scrollbar-hover', sidebarCollapsed ? 'px-2' : 'px-3')}>
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      sidebarCollapsed
                        ...
                        : 'gap-3 px-3 py-2.5 min-h-[44px] border-l-4 border-transparent',
        ...
        <div className={cn('mt-auto border-t border-border/50', sidebarCollapsed ? 'p-2' : 'p-4')}>
          {!sidebarCollapsed ? (
            <div className="space-y-2">
              <Link
