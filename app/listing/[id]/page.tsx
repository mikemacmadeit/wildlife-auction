      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              {/* Price & Auction Info - Prominent Display */}
              <Card className="border-2 bg-gradient-to-br from-primary/5 via-card to-card">
                <CardContent className="pt-6">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    {/* Countdown Timer - Prominent for Auctions */}
                    {listing.type === 'auction' && listing.endsAt && (
                      <div className="md:text-right">
                        <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2">
                          Auction Ends
                        </div>
                        <CountdownTimer endDate={listing.endsAt} variant="compact" />
                      </div>
                    )}
                  </div>
                </CardContent>
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-24 space-y-6">
              ...
              {/* Bid History - For Auctions (eBay Style) */}
        ...
        <div className="lg:hidden mt-6">
          <StickyCTABar 
            ...
            price={listing.price}
            currentBid={listing.currentBid || listing.startingBid}
            onAction={() => {
