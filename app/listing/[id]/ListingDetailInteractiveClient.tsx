...
interface ListingDetailInteractiveClientProps {
  listingId: string;
  initialListing: Listing | null;
}

export default function ListingDetailInteractiveClient({
  listingId,
  initialListing,
}: ListingDetailInteractiveClientProps) {
    ...
    try {
      ...
      if (error.message) {
        if (error.message.includes('must be higher')) {
          ...
          errorMessage = formatUserFacingError(error, 'Failed to place bid. Please try again.');
        }
      } else {
        errorMessage = formatUserFacingError(error, 'Failed to place bid. Please try again.');
      }
