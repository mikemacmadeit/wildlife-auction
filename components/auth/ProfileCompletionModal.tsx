  ...
  return (
    <>
      <Dialog open={open} onOpenChange={() => {}}>
        <DialogContent className="sm:max-w-[500px] max-h-[90dvh] sm:max-h-[90vh] overflow-y-auto overflow-x-hidden p-4 sm:p-6 pb-24 sm:pb-6">
        {showVerifyEmailStep ? (
          <>
            <DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-4">
          ...
          {/* Submit button at bottom of form – scroll to reach it; extra pb on dialog clears bottom nav on mobile */}
          <Button
            type="submit"
