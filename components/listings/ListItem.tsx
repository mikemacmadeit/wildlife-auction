...
import { Listing, WildlifeAttributes, WhitetailBreederAttributes, CattleAttributes, FarmAnimalAttributes, HorseAttributes } from '@/lib/types';
...
const ListItemComponent = React.forwardRef<HTMLDivElement, ListItemProps>(
  ...
  const specs = useMemo(() => {
    ...
    // Show quantity for all modes (single, fixed_group, group_lot) including auctions
    const qtyLabel = (() => {
                ...
                <div className="mt-2 flex items-end justify-between gap-2">
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                      {sold.isSold ? (
                        <span className="text-lg font-extrabold leading-none text-emerald-600 dark:text-emerald-400">
                          {sold.soldPriceLabel}
                        </span>
                      ) : (
                        <span
            ...
            <div className="flex min-w-0">
              ...
              <div className="flex-1 min-w-0 p-2.5 flex flex-col justify-between relative">
                ...
                <div className="mt-1.5 flex flex-wrap items-center gap-x-2 gap-y-0.5">
                  {sold.isSold ? (
                    <span className="text-base font-extrabold text-emerald-600 dark:text-emerald-400 leading-none">{sold.soldPriceLabel}</span>
                  ) : (
                    <>
                      <span
                        className={cn(
            ...
            <div className="flex flex-col gap-3 md:grid md:grid-cols-[1fr_220px] md:gap-5 md:items-stretch">
              ...
              <div className="min-w-0 flex flex-col gap-2">
                ...
                <div className="space-y-1 pt-0.5">
                  ...
                  {sold.isSold ? (
                    <>
                      <div className="text-sm sm:text-base font-extrabold text-emerald-600 dark:text-emerald-400">{sold.soldPriceLabel}</div>
                      {sold.soldDateLabel ? (
