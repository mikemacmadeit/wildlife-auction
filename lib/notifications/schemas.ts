...
export const notificationEventPayloadSchema: z.ZodType<NotificationEventPayload> = z.discriminatedUnion('type', [
  ...
  z.object({
    type: z.literal('Order.DeliveryScheduled'),
    orderId: baseString,
    listingId: baseString,
    listingTitle: baseString,
    orderUrl: urlSchema,
    eta: z.string().optional(),
    proposedWindows: z.array(z.object({ start: z.string(), end: z.string() })).optional(),
    message: z.string().optional(),
  }),
  z.object({
    type: z.literal('Order.DeliveryAgreed'),
    orderId: baseString,
    listingId: baseString,
    listingTitle: baseString,
    orderUrl: urlSchema,
    windowStart: baseString,
    windowEnd: baseString,
  }),
  z.object({
  ...
  z.object({
    type: z.literal('Order.ReceiptConfirmed'),
    orderId: baseString,
    listingId: baseString,
    listingTitle: baseString,
    orderUrl: urlSchema,
  ...
  z.object({
    type: z.literal('Order.FinalPaymentDue'),
    orderId: baseString,
    listingId: baseString,
    listingTitle: baseString,
    orderUrl: urlSchema,
  ...
  z.object({
    type: z.literal('Order.FinalPaymentConfirmed'),
    orderId: baseString,
    listingId: baseString,
    listingTitle: baseString,
    orderUrl: urlSchema,
