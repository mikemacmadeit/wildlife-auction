...
export const notificationEventPayloadSchema: z.ZodType<NotificationEventPayload> = z.discriminatedUnion('type', [
  ...
  z.object({
    type: z.literal('Admin.Listing.Submitted'),
    listingId: baseString,
    listingTitle: baseString,
    sellerId: baseString,
    ...
    pendingReason: z.enum(['admin_approval', 'compliance_review', 'unknown']).optional(),
    listingUrl: urlSchema,
    adminQueueUrl: urlSchema,
    adminComplianceUrl: urlSchema.optional(),
  }),
  z.object({
    type: z.literal('Admin.Listing.ComplianceReviewRequired'),
    listingId: baseString,
    listingTitle: baseString,
    sellerId: baseString,
    sellerName: z.string().optional(),
  ...
  z.object({
    type: z.literal('Admin.Listing.AdminApprovalRequired'),
    listingId: baseString,
    listingTitle: baseString,
    sellerId: baseString,
    sellerName: z.string().optional(),
  ...
  z.object({
    type: z.literal('Admin.Listing.Approved'),
    listingId: baseString,
    listingTitle: baseString,
    sellerId: baseString,
    sellerName: z.string().optional(),
  ...
  z.object({
    type: z.literal('Admin.Listing.Rejected'),
    listingId: baseString,
    listingTitle: baseString,
    sellerId: baseString,
    sellerName: z.string().optional(),
  ...
  z.object({
    type: z.literal('Admin.Order.DisputeOpened'),
    orderId: baseString,
