...
export const EMAIL_EVENT_REGISTRY = [
  {
    ...
    samplePayload: {
      ...
      orderUrl: 'https://agchange.app/dashboard/orders?orderId=ORD_123456',
    },
  ...
  },
  {
    ...
    samplePayload: {
      ...
      orderId: 'ORD_123456',
      listingTitle: 'Axis Doe (Breeder Stock)',
      orderUrl: 'https://agchange.app/dashboard/orders/ORD_123456',
    },
  ...
  },
  {
    ...
    samplePayload: {
      ...
      winningBid: 9500,
      orderUrl: 'https://agchange.app/listing/abc123',
  ...
  },
  {
    ...
    samplePayload: {
      ...
      listingTitle: 'Blackbuck Trophy Buck',
      newBidAmount: 9850,
      listingUrl: 'https://agchange.app/listing/abc123',
  ...
  },
  {
    ...
    samplePayload: {
      userName: 'Alex',
      dashboardUrl: 'https://agchange.app/dashboard/notifications',
    },
  ...
  },
  {
    ...
    samplePayload: {
      ...
      orderId: 'ORD_123456',
      listingTitle: 'Axis Doe (Breeder Stock)',
      orderUrl: 'https://agchange.app/seller/orders/ORD_123456',
    },
  ...
  },
  {
    ...
    samplePayload: {
      userName: 'Alex',
      settingsUrl: 'https://agchange.app/dashboard/account',
  ...
  },
  {
    ...
    samplePayload: {
      userName: 'Alex',
      listings: [
        { title: 'Blackbuck Trophy Buck', url: 'https://agchange.app/listing/abc123', price: 9500, endsAt: new Date().toISOString() },
      ],
      unsubscribeUrl: 'https://agchange.app/dashboard/settings/notifications',
    },
  ...
  },
  {
    ...
    samplePayload: {
      ...
      resultsCount: 4,
      searchUrl: 'https://agchange.app/browse?type=auction',
      unsubscribeUrl: 'https://agchange.app/dashboard/settings/notifications',
    },
  ...
  },
  {
    ...
    samplePayload: {
      userName: 'Jordan',
      listingTitle: 'Axis Doe (Breeder Stock)',
      threadUrl: 'https://agchange.app/seller/messages?threadId=THREAD_123',
  ...
  },
  {
    ...
    samplePayload: {
      userName: 'Alex',
      verifyUrl: 'https://agchange.app/__/auth/action?mode=verifyEmail&oobCode=abc123',
      dashboardUrl: 'https://agchange.app/dashboard/account?verified=1',
    },
  ...
  },
  {
    ...
    samplePayload: {
      ...
      listingTitle: 'Axis Doe (Breeder Stock)',
      amount: 8500,
      offerUrl: 'https://agchange.app/dashboard/offers/ABC123',
    },
  ...
  },
  {
    ...
    samplePayload: {
      ...
      listingTitle: 'Axis Doe (Breeder Stock)',
      amount: 8500,
      offerUrl: 'https://agchange.app/dashboard/offers',
  ...
  },
  {
    ...
    samplePayload: {
      ...
      listingTitle: 'Axis Doe (Breeder Stock)',
      amount: 8500,
      offerUrl: 'https://agchange.app/seller/offers',
      expiresAt: new Date(Date.now() + 48 * 60 * 60 * 1000).toISOString(),
    },
  ...
  },
  {
    ...
    samplePayload: {
      userName: 'Jordan',
      listingTitle: 'Axis Doe (Breeder Stock)',
      editUrl: 'https://agchange.app/seller/listings/LISTING_123/edit',
  ...
  },
  {
    ...
    samplePayload: {
      ...
      listingUrl: 'https://agchange.app/listing/LISTING_123',
      adminQueueUrl: 'https://agchange.app/dashboard/admin/listings',
      adminComplianceUrl: 'https://agchange.app/dashboard/admin/compliance',
    },
  ...
  },
  {
    ...
    samplePayload: {
      ...
      complianceStatus: 'pending_review',
      listingUrl: 'https://agchange.app/listing/LISTING_234',
      adminComplianceUrl: 'https://agchange.app/dashboard/admin/compliance',
    },
  ...
  },
  {
    ...
    samplePayload: {
      ...
      listingUrl: 'https://agchange.app/listing/LISTING_345',
      adminQueueUrl: 'https://agchange.app/dashboard/admin/listings',
    },
  ...
  },
  {
    ...
    samplePayload: {
      ...
      reason: 'death',
      adminOpsUrl: 'https://agchange.app/dashboard/admin/ops',
    },
