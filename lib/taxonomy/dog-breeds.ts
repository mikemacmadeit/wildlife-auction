...
export const DOG_BREED_OPTIONS: SearchableSelectOption[] = [
  ...
  { value: 'chesador', label: 'Chesador (Lab x Chessie)' },
  ...
  { value: 'walker_hound', label: 'Walker Hound' },
  { value: 'leopard_hound', label: 'American Leopard Hound' },
  ...
  { value: 'black_mouth_cur', label: 'Black Mouth Cur' },
  { value: 'mountain_cur', label: 'Mountain Cur' },
  { value: 'blue_lacy', label: 'Blue Lacy' },
  ...
  { value: 'presa_canario', label: 'Presa Canario' },
